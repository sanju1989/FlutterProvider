...
import 'package:skdoosh/view/event/saveunpublishevent.dart';
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("01 September 2023",style: TextStyle(fontSize: 10,color: Colors.white),),
                            //   Text("Location"),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("00:00 Hrs",style: TextStyle(fontSize: 10,color: Colors.white),),
                            // Text("Charges"),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("Random Address",style: TextStyle(fontSize: 18,color: Colors.white),),
                            //   Text("Location"),
                            // Text("Random Address",style: TextStyle(fontSize: 18),),
                          ],
                        ),
...
class EventRequest extends StatefulWidget {
  @override
  _EventRequest createState() => _EventRequest();
}

class _EventRequest extends State<EventRequest> {
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Requested Event",style: TextStyle(color: Colors.white),),
                PopupMenuButton<String>(
                  ...
                  onSelected: (String? value) {
                    if (value == "Save") {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SaveUnpublishEvent()),
                      );
            ...
            child: Row(
              ...
              children: <Widget>[
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      // Navigator.push(context, MaterialPageRoute(builder: (context) => CarouselList()),);
