...
import 'package:skdoosh/utils/swipe_card/allowed_swipe_direction.dart';
import 'package:skdoosh/utils/swipe_card/card_animation.dart';
import 'package:skdoosh/utils/swipe_card/card_swiper_controller.dart';
import 'package:skdoosh/utils/swipe_card/enums.dart';
import 'package:skdoosh/utils/swipe_card/extensions.dart';
import 'package:skdoosh/utils/swipe_card/typedefs.dart';
import 'package:skdoosh/utils/swipe_card/undoable.dart';
...
class _CardSwiperState<T extends Widget> extends State<CardSwiper>
            ...
            builder: (BuildContext context, BoxConstraints constraints) {
              return Stack(
                ...
                children: List.generate(numberOfCardsOnScreen(), (index) {
                  ...
                  debugPrint("front=${_frontItem(constraints)}");
                  debugPrint("back=${_backItem(constraints, index)}");
  ...
  Widget _backItem(BoxConstraints constraints, int index) {
    debugPrint('dy=${widget.backCardOffset.dy}');
    debugPrint('dx=${widget.backCardOffset.dx}');
    debugPrint('diff-y=${_cardAnimation.difference.dy}');
    debugPrint('diff-x=${_cardAnimation.difference.dx}');
    debugPrint('index${index}');
    debugPrint('card scale${_cardAnimation.scale}');
    debugPrint('widget scale${widget.scale}');
    return Positioned(
